...
public class MonsterEntity : SEEntity
{
        ...
        public void initialize(SEResourceCache rsc) {
                ...
                rsc.prepare_image("slark", "slark", w*0.20, h*0.30);
                rsc.prepare_image("go","go",get_scene_width(),get_scene_height());
                //bg1 = add_sprite_for_image(SEImage.for_resource("gm"));
                monster = add_sprite_for_image(SEImage.for_resource("slark"));
